...
class App extends React.Component {
  ...
  state = {
    houses : [
      ...
      {id: 2, houseimg: house2, star: 4, guestImg: guest2, guestName: "Charlie", guestFrom:"Gana", review: "Very accommodating with my booking and welcoming to all of us. Thanks!"},
